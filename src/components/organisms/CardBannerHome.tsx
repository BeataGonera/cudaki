...
const CardBannerHome = () => {
  return (
    <div className="flex flex-col lg:flex-row-reverse justify-between w-full gap-2 h-screen pt-24 lg:h-[80vh] lg:pt-48 px-2 bg-beige-bg lg:px-24 xl:px-48 2xl:px-128">
