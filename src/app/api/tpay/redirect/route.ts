...
export async function POST(req: NextRequest) {
  ...
  const crc = "985"; // Optional, you can leave it empty or use it for tracking purposes
  const resultUrl = "https://cudaki.vercel.app/api/tpay/verify"; // Your endpoint for Tpay notifications
